...
## This repository
We systematically compared the NEP methods provided by Giotto, IMCRtools (classic and histoCAT), MISTy, SEA, Squidpy, Scimap, CellCharter and our newly proposed method COZI. We evaluate the methods on simulated tissue cohorts and on a real myocardial infarction (MI) dataset and provide scripts for the analysis and Figures in the Schiller et al 2025 biorxiv publicatino here. 
