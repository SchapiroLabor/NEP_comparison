...
files = list.files("./../../../../data/Sim_nbh15_sym00_1000_grid0.2_1kiter_025kswap/", pattern = ".csv")
data_path = "./../../../../data/Sim_nbh15_sym00_1000_grid0.2_1kiter_025kswap/"
```
...
#save the abundance files for running
write.csv(abundances, "./../../results_4ct_sym/ct_abundances_delaunay_4ct_self00.csv", row.names = TRUE)
