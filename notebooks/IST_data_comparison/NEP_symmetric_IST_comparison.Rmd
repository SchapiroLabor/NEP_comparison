...
#plot paths
output_path_Fig2d_boxplots_sym = "./../../../../../Paper_figures/condzscore_v3/sym_F1_detailed_2rows_wcellcharter.svg"
output_path_Fig2b_summary_boxplots_sym = "./../../../../../Paper_figures/condzscore_v3/sym_comparison_F1_summary_alltools_wcellcharter.svg"
output_path_appendix_Fig5_heatmap = "./../../../../../Paper_figures/condzscore_v3/appendix_sym_feature_imp_heatmap_wcellcharter.svg"
...
#write.csv2(df_all_avg_clean, "./../../../../../data/Source_data/Source_2d.csv", row.names = TRUE, fileEncoding = "UTF-8")
```

```{r}
# save source data
df = df_all_avg_clean %>% select(tool, comparison_preference, abundance_ct_0, F1)
write.csv2(df, "./../../../../../data/Source_data/Source_Sup_1a.csv", row.names = TRUE, fileEncoding = "UTF-8")
```
...
custom_palette <- c("#1b9e77", "#d95f02", "#7570b3", "#e7298a", "#66a61e", "#e6ab02", "#a6761d", "#666666", "#c44e52", "white", "#76B1F1", "yellow")
...
# rename tools
rename_map <- c(
  "cellcharter_enrichment" = "CellCharter",
  "cellcharter_notsymmetric_nohomo_enrichment"= "CellCharter*",
  "cond_zscore_scimap"= "COZI",
  "IMCRtools_classic_sigval"= "IMCRclassic",
  "histoCAT_sigval" = "histoCAT",
  "Misty_delauany" = "Misty",
  "scimap"  = "Scimap",
  "SEA_zscore_scimap" = "SEA",
  "squidpy_count" = "Interaction count",
  "squidpy_zscore" = "Squidpy"
)
rownames(df_merge) <- dplyr::recode(rownames(df_merge), !!!rename_map)
# Define your custom order
keep_rows <- c("Misty", "COZI", "histoCAT", "CellCharter*", "IMCRclassic", "Scimap", "Giotto", "CellCharter", "Squidpy", "SEA", "Interaction count")

df_merge <- df_merge[rownames(df_merge) %in% keep_rows, , drop = FALSE]
...
```
```{r}
#save source data Sup fig 4b
write.csv2(df_merge, "./../../../../../data/Source_data/Source_Sup_4b.csv", row.names = TRUE, fileEncoding = "UTF-8")
...
cosine_similarities_clean_filtered <- na.omit(cosine_similarities_clean_filtered)
cosine_similarities_clean_filtered$abundance_ct_0 <- recode(
  cosine_similarities_clean_filtered$abundance_ct_0,
  "0.05" = "0.14 - 0.22",
  "0.1"  = "0.17 - 0.23",
  "0.15" = "0.19 - 0.24",
  "0.2"  = "0.22 - 0.24",
...
write.csv2(cosine_similarities_clean_filtered, "./../../../../../data/Source_data/Source_3c.csv", row.names = TRUE, fileEncoding = "UTF-8")
```
