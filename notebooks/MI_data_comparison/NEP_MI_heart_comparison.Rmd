...
# output_paths
output_path_NEP_immune_Endocardial_Fig4d_heatmaps = "./../../../../../Paper_figures/condzscore_v3/Fig4d_MI_data_heatmaps.svg"
output_path_NEP_immune_Ankrd1_Fig4c_heatmaps = "./../../../../../Paper_figures/condzscore_v3/Fig4c_MI_NEP_immune_Ankrd1_heatmaps.svg"
output_path_NEP_immune_Endothelial_appendix_heatmaps = "./../../../../../Paper_figures/condzscore_v3/Appendix_Fig_MI_NEP_immune_Endothelial_heatmaps.svg"
```
...
method_renames <- c(
  ...
  "IMCRclassic_p_lt_knn5.csv" = "IMCRtools Classic",
  "histoCAT_p_lt_knn5.csv" = "histoCAT",
  "MI_Misty_knn5.csv" = "Misty",
  "MI_scimap_knn5.csv" = "Scimap",
  "MI_SEA_scimap_knn5.csv" = "SEA",
  "squidpy_count_delaunay_4ct_cross01.csv" = "Interaction count",
  "squidpy_zscore_delaunay_4ct_cross01.csv" = "Squidpy"
)
```
...
plot_heatmaps <- function(all, selected_columns, new_column_names, method_renames, order_rownames, update_rownames, save_path = NULL) {
  ...
  if (!is.null(save_path)) {
    svg(save_path, width = 9, height = 8)
    grid.arrange(grobs = lapply(heatmaps, function(x) x$gtable), ncol = 2)
    dev.off()
  }
}
